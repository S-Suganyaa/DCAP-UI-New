...
interface ManageGradingTemplateListProps {
    data?: ManageGradingRow[];
...
const ManageGradingTemplateList: React.FC<ManageGradingTemplateListProps> = ({
    data = [],
    onFilterChange,
    selectedFilters = {}
}) => {
...
export default ManageGradingTemplateList;